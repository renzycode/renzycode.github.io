...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
    <div class="container">
      ...
      <button class="navbar-toggler text-uppercase font-weight-bold text-white rounded" type="button"
        ...
        <i class="fas fa-bars fa-2x p-0"></i>
      </button>
  ...
  <header class="masthead bg-primary text-white text-center" id="home">
    <div class="container d-flex align-items-center flex-column">
      ...
      <img class="masthead-avatar mb-5 rounded" src="assets/img/profile.jpg" alt="..." />
      <!-- Masthead Heading-->
      <h1 class="masthead-heading text-uppercase mb-0">Renzy John Minerva</h1>
      <!-- Icon Divider-->
      <div class="divider-custom divider-light">
      </div>
      <!-- Masthead Subheading-->
      <p class="masthead-subheading font-weight-light mb-0">Web Developer - Programmer - Music Producer</p>
    </div>
  </header>

    <!-- About Section-->
    <section class="page-section bg-white text-dark mb-0 mx-2" id="about">
      <div class="container">
...
<?php
  $skillList = [
    ['name'=>'Javascript','value'=>'51'],
    ['name'=>'Python','value'=>'78'],
    ['name'=>'C/C++','value'=>'55'],
    ['name'=>'HTML5','value'=>'80'],
    ['name'=>'CSS','value'=>'79'],
    ['name'=>'PHP','value'=>'91'],
    ['name'=>'Reactjs','value'=>'32'],
    ['name'=>'LARAVEL','value'=>'84'],
    ['name'=>'SQL','value'=>'78'],
    ['name'=>'Reactnative','value'=>'78'],
  ]
?>
  ...
  <section class="page-section bg-primary text-white mb-0" id="skills">
    <div class="container">
      <!-- About Section Heading-->
      <h2 class="page-section-heading text-center text-uppercase text-white">Coding Skills</h2>
      <!-- Icon Divider-->
      <div class="divider-custom divider-light">
      </div>
      <!-- About Section Content-->
      <div class="row">
        <?php
          foreach($skillList as $s) {
            echo '
            <div class="col-lg-6 ms-auto mx-auto mb-2">
              <label for="'.$s['name'].'" class="lead mb-1">'.$s['name'].'</label>
              <div class="progress bg-light" style="height: 30px;">
                <div class="progress-bar bg-dark" role="progressbar" style="width: '.$s['value'].'%;" aria-valuenow="'.$s['value'].'" aria-valuemin="0" aria-valuemax="100">'.$s['value'].'%</div>
              </div>
            </div>
            ';
          }
  ...
  <div class="copyright py-4 text-center text-white">
    <div class="container"><small>Copyright &copy; Renzy John Minerva 2022</small></div>
  </div>
  <!-- Portfolio Modals-->
          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-lg-8">
                ...
                <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia neque assumenda ipsam
